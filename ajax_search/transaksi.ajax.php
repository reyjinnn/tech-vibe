...
if (isset($_GET['cari'])) {
    ...
    $keyword = $_GET['cari'];
    $hasil = mysqli_query($konek, "SELECT * FROM transaksi JOIN status ON status.id_status = transaksi.id_status WHERE id_pesan LIKE'%$keyword%' OR penerima LIKE '%$keyword%' OR keterangan LIKE '%$keyword%' ");
    $transaksi = [];

...
?>
<div class="detail-produk p-3 mt-3 text-black">
    <div class="judul">
        <h5>Detail Produk <?= $produk['produk']->kategori . " " . $produk['produk']->nama ?></h5>
    </div>
    <div class="card w-100 text-dark my-3">
        ...
        <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <select class="form-control " name="kategori" id="">
                        <option>--Pilih--</option>
                        <option value="Ponsel" <?= $produk['produk']->kategori == 'Ponsel' ? 'selected' : '' ?>>Ponsel</option>
                        <option value="Laptop" <?= $produk['produk']->kategori == 'Laptop' ? 'selected' : '' ?>>Laptop</option>
                        <option value="Komputer" <?= $produk['produk']->kategori == 'Komputer' ? 'selected' : '' ?>>Komputer</option>
                    </select>
                </div>
                <div class="form-group mx-2 col-sm-5 ">
            ...
            <div class=" text-center my-3">
                ...
                <button type="button" onclick="location.href=''" class="btn btn-sm btn-danger w-25" class="card-link">Hapus</button>
            </div>
        </form>
    </div>
</div>
